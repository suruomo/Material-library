...
public class GridStressResult implements Serializable {
    ...
    public String getConMises() {
        return conMises;
    }

    public void setConMises(String conMises) {
        this.conMises = conMises == null ? null : conMises.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        GridStressResult other = (GridStressResult) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getConMises() == null ? other.getConMises() == null : this.getConMises().equals(other.getConMises()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getConMises() == null) ? 0 : getConMises().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", conMises=").append(conMises);
